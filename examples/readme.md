...
INFO	2018-09-24 00:59:33,000	class Driver(loggedpy.Driver):
...
INFO	2018-09-24 01:00:10,578	5,6-5,12:           NAME           'Driver'       
...
INFO	2018-09-24 01:00:10,579	5,22-5,28:          NAME           'Driver'       
...
```console
$ loggedpy --loggedpy-driver=./customized.py:Driver 00*.py
...
```console
$ loggedpy --loggedpy-driver=./customized.py:Driver 01*.py
...
```console
$ loggedpy --loggedpy-driver=./customized.py:Driver loggedpy-cat customized.py
...
INFO	2018-09-24 01:00:47,985	loggedpy-cat	in	_cat.py:8	main	class Driver(loggedpy.Driver):
...
```console
$ loggedpy --loggedpy-driver=./customized.py:Driver -m tokenize customized.py
...
INFO	2018-09-24 01:01:02,739	tokenize	in	tokenize.py:708	main	5,6-5,12:           NAME           'Driver'       
...
INFO	2018-09-24 01:01:02,740	tokenize	in	tokenize.py:708	main	5,22-5,28:          NAME           'Driver'       
